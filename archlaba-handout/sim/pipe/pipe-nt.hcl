...
intsig D_valC 'if_id_curr->valc'	 # Fetched Constant
...
int f_pc = [
    ...
    # JMP can always use F_predPC directly
...
int f_predPC = [
	# JMP to jump directly, other JXXs fetch valP
	(f_icode == ICALL) || (f_icode == IJXX && f_ifun == 0) : f_valC;
	1 : f_valP;
];
...
int d_valA = [
	...
	D_icode in { IJXX } : D_valC;  # Use fetched Address
